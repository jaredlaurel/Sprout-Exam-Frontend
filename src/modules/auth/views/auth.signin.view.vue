      ...
      >
        ...
        <v-container>
          <v-form ref="form" v-model="valid">
            ...
            <v-row>
              <span v-if="showInvalidCreds" class="ml-13" style="color:red">Invalid username or password.</span>
            </v-row>
            <v-row>
              <v-col cols="6">
                <!-- TODO fix diabled <v-btn :disabled="!valid" color="success" class="mr-4" @click="validate">Validate</v-btn> -->
                <v-btn :flat="config.vuetify.theme.flat" color="success" class="mr-4" @click="validate">Sign In</v-btn>
